...
public class BloodBankAdapterAdmin extends RecyclerView.Adapter<BloodBankAdapterAdmin.BloodBankHolder> implements Filterable {

    Context  context;
    List<BloodBankModel> bloodBankData;
    List<BloodBankModel> bloodBankDataFilter;

    public BloodBankAdapterAdmin(Context context, List<BloodBankModel> bloodBankData) {
    ...
    public BloodBankHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        return new BloodBankAdapterAdmin.BloodBankHolder(layout);
    }
